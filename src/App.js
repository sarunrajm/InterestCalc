  ...
  return (
    <div style={{ height: "100vh" }} className='d-flex justify-content-center align-items-center bg-dark '>
      <div style={{ width: "500px" }} className=' bg-white rounded p-5 '>
        ...
        <div style={{ height: "150px" }} className='shadow d-flex justify-content-center align-items-center flex-column bg-secondary rounded'>
          <h1>
            ₹ {' '}{interest}
          </h1>
          <p className='fw-bold'>
        ...
        <form onSubmit={handleCalculate} className='mt-5'>
          ...
          <Stack direction="row" spacing={2}>
            <Button type='submit' style={{width:'200px',height:'70px'}} className='bg-dark text-info' variant="contained" disabled={isValid && israteValid && isyearValid?false:true} >Calculate</Button>
